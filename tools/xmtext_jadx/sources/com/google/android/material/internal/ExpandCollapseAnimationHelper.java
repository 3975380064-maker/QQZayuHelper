...
public class ExpandCollapseAnimationHelper {
    ...
    private Animator getExpandCollapseAnimator(boolean z) {
        ...
        valueAnimatorOfObject.addUpdateListener(new ValueAnimator.AnimatorUpdateListener() { // from class: com.google.android.material.internal.ExpandCollapseAnimationHelper$$ExternalSyntheticLambda0
            ...
            public final void onAnimationUpdate(ValueAnimator valueAnimator) {
                this.f$0.m91lambda$getExpandCollapseAnimator$0$comgoogleandroidmaterialinternalExpandCollapseAnimationHelper(rect, valueAnimator);
            }
        });
    ...
    /* synthetic */ void m91lambda$getExpandCollapseAnimator$0$comgoogleandroidmaterialinternalExpandCollapseAnimationHelper(Rect rect, ValueAnimator valueAnimator) {
