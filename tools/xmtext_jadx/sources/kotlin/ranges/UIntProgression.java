...
public class UIntProgression implements Iterable<UInt>, KMappedMarker {
    ...
    public final int m1358getFirstpVg5ArA() {
        return this.first;
    }

    /* renamed from: getLast-pVg5ArA, reason: not valid java name */
    public final int m1359getLastpVg5ArA() {
        return this.last;
    }
    ...
    public String toString() {
        ...
        int i;
        if (this.step > 0) {
            sbAppend = new StringBuilder().append((Object) UInt.m276toStringimpl(this.first)).append("..").append((Object) UInt.m276toStringimpl(this.last)).append(" step ");
            i = this.step;
        } else {
            sbAppend = new StringBuilder().append((Object) UInt.m276toStringimpl(this.first)).append(" downTo ").append((Object) UInt.m276toStringimpl(this.last)).append(" step ");
            i = -this.step;
        }
    ...
    public static final class Companion {
        ...
        public final UIntProgression m1360fromClosedRangeNkh28Cs(int i, int i2, int i3) {
