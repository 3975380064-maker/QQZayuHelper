        ...
        public final Object putImpl(K k, V v, HashedWeakRef<K> hashedWeakRef) {
            ...
            while (true) {
                ...
                if (hashedWeakRef2 != null) {
                    ...
                    if (ConcurrentWeakMap$Core$$ExternalSyntheticBackportWithForwarding0.m(this.keys, iIndex, null, hashedWeakRef)) {
                        break;
                    }
                } else {
                    return null;
            ...
            } while (!ConcurrentWeakMap$Core$$ExternalSyntheticBackportWithForwarding0.m(this.values, iIndex, obj, v));
            return obj;
        }
