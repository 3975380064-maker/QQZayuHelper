...
final class ReceiveChannel$onReceiveOrNull$1$registerSelectClause1$1<E, R> extends SuspendLambda implements Function2<ChannelResult<? extends E>, Continuation<? super R>, Object> {
    ...
    public /* bridge */ /* synthetic */ Object invoke(Object obj, Object obj2) {
        return m1663invokeWpGqRn0(((ChannelResult) obj).m1659unboximpl(), (Continuation) obj2);
    }

    /* renamed from: invoke-WpGqRn0, reason: not valid java name */
    public final Object m1663invokeWpGqRn0(Object obj, Continuation<? super R> continuation) {
        return ((ReceiveChannel$onReceiveOrNull$1$registerSelectClause1$1) create(ChannelResult.m1647boximpl(obj), continuation)).invokeSuspend(Unit.INSTANCE);
    }
    ...
    public final Object invokeSuspend(Object obj) throws Throwable {
        ...
        ResultKt.throwOnFailure(obj);
        Object objM1659unboximpl = ((ChannelResult) this.L$0).m1659unboximpl();
        Throwable thM1651exceptionOrNullimpl = ChannelResult.m1651exceptionOrNullimpl(objM1659unboximpl);
        if (thM1651exceptionOrNullimpl != null) {
            throw thM1651exceptionOrNullimpl;
        }
        Function2<E, Continuation<? super R>, Object> function2 = this.$block;
        Object objM1652getOrNullimpl = ChannelResult.m1652getOrNullimpl(objM1659unboximpl);
        this.label = 1;
        Object objInvoke = function2.invoke(objM1652getOrNullimpl, this);
