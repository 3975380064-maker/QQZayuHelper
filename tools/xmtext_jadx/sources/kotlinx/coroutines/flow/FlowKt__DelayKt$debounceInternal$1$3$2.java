...
final class FlowKt__DelayKt$debounceInternal$1$3$2 extends SuspendLambda implements Function2<ChannelResult<? extends Object>, Continuation<? super Unit>, Object> {
    ...
    public /* bridge */ /* synthetic */ Object invoke(ChannelResult<? extends Object> channelResult, Continuation<? super Unit> continuation) {
        return m1671invokeWpGqRn0(channelResult.m1659unboximpl(), continuation);
    }

    /* renamed from: invoke-WpGqRn0, reason: not valid java name */
    public final Object m1671invokeWpGqRn0(Object obj, Continuation<? super Unit> continuation) {
        return ((FlowKt__DelayKt$debounceInternal$1$3$2) create(ChannelResult.m1647boximpl(obj), continuation)).invokeSuspend(Unit.INSTANCE);
    }
    ...
    public final Object invokeSuspend(Object obj) throws Throwable {
        ...
        if (i == 0) {
            ...
            ?? M1659unboximpl = ((ChannelResult) this.L$0).m1659unboximpl();
            Ref.ObjectRef<Object> objectRef3 = this.$lastValue;
            boolean z = M1659unboximpl instanceof ChannelResult.Failed;
            if (!z) {
                objectRef3.element = M1659unboximpl;
            }
            objectRef = this.$lastValue;
            FlowCollector<T> flowCollector = this.$downstream;
            if (z) {
                Throwable thM1651exceptionOrNullimpl = ChannelResult.m1651exceptionOrNullimpl(M1659unboximpl);
