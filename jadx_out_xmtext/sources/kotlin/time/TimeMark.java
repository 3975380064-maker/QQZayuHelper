...
public interface TimeMark {
    ...
    TimeMark mo1452minusLRDsOJo(long j);

    /* renamed from: plus-LRDsOJo */
    TimeMark mo1454plusLRDsOJo(long j);

    /* compiled from: TimeSource.kt */
    @Metadata(k = 3, mv = {1, 9, 0}, xi = ConstraintLayout.LayoutParams.Table.LAYOUT_CONSTRAINT_VERTICAL_CHAINSTYLE)
    public static final class DefaultImpls {
        /* renamed from: plus-LRDsOJo, reason: not valid java name */
        public static TimeMark m1599plusLRDsOJo(TimeMark timeMark, long j) {
            return new AdjustedTimeMark(timeMark, j, null);
        }

        /* renamed from: minus-LRDsOJo, reason: not valid java name */
        public static TimeMark m1598minusLRDsOJo(TimeMark timeMark, long j) {
            return timeMark.mo1454plusLRDsOJo(Duration.m1514unaryMinusUwyO8pc(j));
        }

        public static boolean hasPassedNow(TimeMark timeMark) {
            return !Duration.m1494isNegativeimpl(timeMark.mo1451elapsedNowUwyO8pc());
        }
