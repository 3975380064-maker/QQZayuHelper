...
public interface SendChannel<E> {
    ...
    Object mo1642trySendJP2dKIU(E e);
    ...
    public static final class DefaultImpls {
        ...
        public static <E> boolean offer(SendChannel<? super E> sendChannel, E e) throws Throwable {
            Object objMo1642trySendJP2dKIU = sendChannel.mo1642trySendJP2dKIU(e);
            if (ChannelResult.m1657isSuccessimpl(objMo1642trySendJP2dKIU)) {
                return true;
            }
            Throwable thM1651exceptionOrNullimpl = ChannelResult.m1651exceptionOrNullimpl(objMo1642trySendJP2dKIU);
