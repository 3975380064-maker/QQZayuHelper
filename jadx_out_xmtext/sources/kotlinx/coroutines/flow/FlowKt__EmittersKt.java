    ...
    public static final class AnonymousClass1<R> extends SuspendLambda implements Function2<FlowCollector<? super R>, Continuation<? super Unit>, Object> {
        ...
        public final Object invokeSuspend(Object obj) throws Throwable {
            ...
            if (i == 0) {
                ...
                this.label = 1;
                if (this.$this_transform.collect(new C00041(this.$transform, flowCollector), this) == coroutine_suspended) {
        ...
        public final Object invokeSuspend$$forInline(Object obj) {
            this.$this_transform.collect(new C00041(this.$transform, (FlowCollector) this.L$0), this);
            return Unit.INSTANCE;
        }
    }
