...
import com.example.xmtext.TextReplaceService;
    ...
    public final void parkedWorkersStackTopUpdate(Worker worker, int i, int i2) {
        while (true) {
            ...
            if (iParkedWorkersStackNextIndex >= 0) {
                if (parkedWorkersStack$FU.compareAndSet(this, j, j2 | iParkedWorkersStackNextIndex)) {
                    return;
                }
            }
        }
