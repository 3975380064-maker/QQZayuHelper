...
public class TransitionManager {
    ...
    private static void changeScene(Scene scene, Transition transition) {
        ...
        Transition transitionMo44clone = transition.mo44clone();
        transitionMo44clone.setSceneRoot(sceneRoot);
        if (currentScene != null && currentScene.isCreatedFromLayoutResource()) {
            transitionMo44clone.setCanRemoveViews(true);
        }
        sceneChangeSetup(sceneRoot, transitionMo44clone);
        scene.enter();
        sceneChangeRunTransition(sceneRoot, transitionMo44clone);
    }
    ...
    public static void beginDelayedTransition(ViewGroup viewGroup, Transition transition) {
        ...
        Transition transitionMo44clone = transition.mo44clone();
        sceneChangeSetup(viewGroup, transitionMo44clone);
        Scene.setCurrentScene(viewGroup, null);
        sceneChangeRunTransition(viewGroup, transitionMo44clone);
    }
