    ...
    private static List<KeylineState> getStateStepsStart(KeylineState keylineState) {
        ...
        if (!isFirstFocalItemAtLeftOfContainer(keylineState) && iFindFirstInBoundsKeylineIndex != -1) {
            ...
            for (int i = 0; i <= firstFocalKeylineIndex; i++) {
                ...
                arrayList.add(moveKeylineAndCreateKeylineState(keylineState2, iFindFirstInBoundsKeylineIndex, size, f, (keylineState.getFirstFocalKeylineIndex() - i) - 1, (keylineState.getLastFocalKeylineIndex() - i) - 1));
            }
        }
        return arrayList;
    }
